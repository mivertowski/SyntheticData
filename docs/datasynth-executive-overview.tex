...
\begin{flushleft}
  ...
  {\normalsize\textcolor{white!50}{Rust core \textbullet{} Python 1.5 \textbullet{} REST/gRPC API \textbullet{} Desktop UI \textbullet{} Helm/Docker}}
\end{flushleft}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.10.0}}}\\[1.5em]
  \textcolor{midgray}{%
...
Python Wrapper &
  \texttt{datasynth-py} 1.5 with blueprints (sourcing, HR, manufacturing,
