...
\fancyhead[R]{\small\textcolor{midgray}{v0.9.5}}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.9.5}}}\\[1.5em]
  \textcolor{midgray}{%
...
\textit{New in v0.8.0, expanded in v0.9.5} --- pluggable JSON-based country configuration replacing
...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  ...
  \item \textit{New in v0.9.5}: External confirmations per ISA 505 --- AR (40\%),
...
\textit{Expanded in v0.9.5} --- comprehensive drift modeling with dedicated generators
