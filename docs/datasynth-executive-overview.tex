...
\fancyhead[R]{\small\textcolor{midgray}{v0.10.0}}
...
\textit{New in v0.8.0, expanded in v0.10.0} --- pluggable JSON-based country configuration replacing
...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  ...
  \item \textit{New in v0.10.0}: External confirmations per ISA 505 --- AR (40\%),
...
\textit{Expanded in v0.10.0} --- comprehensive drift modeling with dedicated generators
