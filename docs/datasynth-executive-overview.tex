...
\fancyhead[R]{\small\textcolor{midgray}{v1.5.0}}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 1.5.0}}}\\[1.5em]
  \textcolor{midgray}{%
...
\begin{itemize}[leftmargin=1.2em, itemsep=3pt]
  ...
  \item \textbf{Methodology-driven audit simulation} --- loads ISA and IIA-GIAS
        audit procedures as YAML-defined finite state machines, producing
        event-sourced audit trails with 1{,}900+ typed artifacts per engagement.
\end{itemize}
\end{tcolorbox}
...
\textit{New in v1.5.0} --- DataSynth introduces a methodology-driven approach to audit data
...
\begin{itemize}[leftmargin=1.2em, itemsep=3pt]
  \item \textbf{Blueprints} define procedures, phases, state transitions,
        evidence requirements, actors, and standards references. Two built-in
        blueprints are included; additional blueprints are available at
        \url{https://github.com/mivertowski/SyntheticDataBlueprints}.
...
\toprule
\textbf{Blueprint} & \textbf{Procedures} & \textbf{Phases} & \textbf{Steps} & \textbf{Standards} & \textbf{Events} & \textbf{Artifacts} \\
\midrule
