...
\fancyhead[R]{\small\textcolor{midgray}{v0.6.0}}
...
\begin{flushleft}
  ...
  {\normalsize\textcolor{white!50}{Rust core \textbullet{} Python 1.1 \textbullet{} REST/gRPC API \textbullet{} Desktop UI \textbullet{} Helm/Docker}}
\end{flushleft}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.6.0}}}\\[1.5em]
  \textcolor{midgray}{%
...
\textit{New in v0.6.0} --- five end-to-end process chains with full
referential integrity, temporal coherence, and anomaly injection:
...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  ...
  \item \textbf{Reference Models}: Canonical P2P (9 activities), O2C (10 activities), R2R (11 activities), S2C (9 activities), H2R, and MFG process models for conformance checking.
  \item \textbf{30+ R2R/A2R/S2C Activities}: GL posting, FX revaluation, period close, depreciation, consolidation, sourcing, qualification, bidding, contract management.
...
\begin{tabularx}{\textwidth}{>{\bfseries}l X}
  ...
  RustGraph Hyper   & Multi-layer hypergraph export (entity, temporal, process
                      layers with cross-layer edges).
\end{tabularx}
\end{tcolorbox}
...
Python Wrapper &
  \texttt{datasynth-py} 1.1 with blueprints (sourcing, HR, manufacturing,
  financial reporting), pandas/polars integration, async client, and
...
A 7-job GitHub Actions pipeline ensures release quality:
