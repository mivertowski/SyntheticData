...
\fancyhead[R]{\small\textcolor{midgray}{v0.11.0}}
...
\begin{flushleft}
  ...
  {\normalsize\textcolor{white!50}{Rust core \textbullet{} Python 1.7 \textbullet{} REST/gRPC API \textbullet{} Desktop UI \textbullet{} Helm/Docker}}
\end{flushleft}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.11.0}}}\\[1.5em]
  \textcolor{midgray}{%
...
\begin{flushleft}
  \textcolor{midgray}{\small
    Built with Rust \& Python \textbullet{} 15 modular crates \textbullet{} 200\,K+ entries/sec\\[4pt]
...
Python Wrapper &
  \texttt{datasynth-py} 1.7 with blueprints (sourcing, HR, manufacturing,
