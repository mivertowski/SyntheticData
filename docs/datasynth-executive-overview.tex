...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.3.0}}}\\[1.5em]
  \textcolor{midgray}{%
...
Streaming Output &
  CSV, JSON, NDJSON, and Parquet streaming sinks with backpressure strategies
...
\begin{enumerate}[leftmargin=1.4em, itemsep=3pt]
  \item \textbf{Statistical Fidelity} --- KS statistic, Wasserstein distance,
        Benford's Law MAD, Anderson-Darling goodness-of-fit.
