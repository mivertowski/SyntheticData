...
\fancyhead[R]{\small\textcolor{midgray}{v0.5.0}}
...
\begin{flushleft}
  ...
  {\normalsize\textcolor{white!50}{Rust core \textbullet{} Python 1.0 \textbullet{} REST/gRPC API \textbullet{} Desktop UI \textbullet{} Helm/Docker}}
\end{flushleft}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.5.0}}}\\[1.5em]
  \textcolor{midgray}{%
...
\begin{tcolorbox}[statbox, width=4.8cm]
  \centering
  {\fontsize{26}{30}\selectfont\bfseries\textcolor{accent}{40+}}\\[3pt]
...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  ...
  \item \textbf{Reference Models}: Canonical P2P (9 activities), O2C (10 activities), and R2R (11 activities) process models for conformance checking.
  \item \textbf{17 R2R/A2R Activities}: GL posting, FX revaluation, period close, depreciation, consolidation.
...
Python Wrapper &
  \texttt{datasynth-py} 1.0 with blueprints, pandas/polars integration,
  async client, and WebSocket streaming support. \\
\bottomrule
\end{tabularx}
\end{table}
