...
\fancyhead[R]{\small\textcolor{midgray}{v0.6.2}}
...
\begin{flushleft}
  ...
  {\Large\textcolor{brand}{\textbf{Version 0.6.2}}}\\[1.5em]
  \textcolor{midgray}{%
...
\textit{Updated in v0.6.2} --- seven end-to-end process chains with full
...
\textit{Major expansion in v0.6.2} --- Object-Centric Event Logs now cover
all 8 enterprise process families with 88 activity types and 52 object types,
...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  ...
  \item \textbf{8 Process Families}: P2P~(9), O2C~(10), R2R/A2R~(17), S2C~(8), H2R~(8), MFG~(10), BANK~(8), AUDIT~(10) --- 88 activities total.
  \item \textbf{52 Object Types}: Lifecycle states and relationships across all families --- from purchase orders through audit engagements.
...
\noindent
\textit{Expanded in v0.6.2} --- the multi-layer hypergraph now spans all 8
