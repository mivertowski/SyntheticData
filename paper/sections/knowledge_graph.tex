...
Unlike accounting networks constructed from real data via inverse
recovery (\Cref{sec:gt_inverse}), \system{}'s graphs are generated
\emph{forward}: every edge has known provenance, eliminating the
