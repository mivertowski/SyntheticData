...
\begin{itemize}
  ...
  \item \textbf{Audit trail edges:} When the FSM-driven audit engine is
    active, additional edges connect engagement nodes to workpapers,
    workpapers to evidence, findings to assessed risks, and audit
    opinions to findings---each annotated with the governing ISA or
    IIA-GIAS procedure step that produced the artifact.
