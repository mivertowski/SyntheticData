...
\begin{enumerate}
  ...
  \item \textbf{Methodology-driven audit simulation.}  The YAML-based
    audit FSM engine opens several research directions:
    (a)~optimization of audit procedures via graph-theoretic analysis of
    methodology state machines, (b)~Monte Carlo estimation of engagement
    outcome distributions under varying overlay parameters, and
    (c)~extension to additional audit frameworks (e.g., EY~GAM,
    KPMG~AAER) through custom blueprint definitions.
\end{enumerate}
