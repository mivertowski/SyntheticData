...
\noindent
The journal entry and line item throughput improvements stem from cached
temporal CDFs, \texttt{SmallVec} line items, parallel generation with
deterministic seed splitting, and \texttt{itoa}/\texttt{ryu} fast formatting.
