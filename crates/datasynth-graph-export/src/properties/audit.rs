...
impl PropertySerializer for ProcedureStepPropertySerializer {
    ...
    fn serialize(
        ...
        props.insert(
            "stepNumber".into(),
            Value::Number(step.step_number.into()),
        );
        props.insert(
            "description".into(),
        ...
        props.insert(
            "exceptionNoted".into(),
            Value::Bool(step.exception_noted),
        );
        if let Some(desc) = &step.exception_description {
            props.insert(
                "exceptionDescription".into(),
...
impl PropertySerializer for SamplePropertySerializer {
    ...
    fn serialize(
        ...
        props.insert(
            "sampleRef".into(),
            Value::String(sample.sample_ref.clone()),
        );
        props.insert(
            "workpaperId".into(),
        ...
        props.insert(
            "itemCount".into(),
            Value::Number(sample.items.len().into()),
        );
...
impl PropertySerializer for AnalyticalProcedurePropertySerializer {
    ...
    fn serialize(
        ...
        props.insert(
            "threshold".into(),
            Value::String(ap.threshold.to_string()),
        );
        props.insert(
            "thresholdBasis".into(),
        ...
        props.insert(
            "variance".into(),
            Value::String(ap.variance.to_string()),
        );
        props.insert(
...
impl PropertySerializer for IaFunctionPropertySerializer {
    ...
    fn serialize(
        ...
        props.insert(
            "headOfIa".into(),
            Value::String(iaf.head_of_ia.clone()),
        );
        props.insert(
        ...
        props.insert(
            "staffCount".into(),
            Value::Number(iaf.staff_count.into()),
        );
        props.insert(
...
impl PropertySerializer for IaReportPropertySerializer {
    ...
    fn serialize(
        ...
        props.insert(
            "reportId".into(),
            Value::String(iar.report_id.to_string()),
        );
        props.insert(
            "reportRef".into(),
            Value::String(iar.report_ref.clone()),
        );
        props.insert(
            "engagementId".into(),
        ...
        props.insert(
            "auditArea".into(),
            Value::String(iar.audit_area.clone()),
        );
        props.insert(
            "reportDate".into(),
        ...
        props.insert(
            "methodology".into(),
            Value::String(iar.methodology.clone()),
        );
        props.insert(
            "overallRating".into(),
        ...
        props.insert(
            "type".into(),
            Value::String("internal_audit_report".into()),
        );
...
impl PropertySerializer for RelatedPartyTransactionPropertySerializer {
    ...
    fn serialize(
        ...
        props.insert(
            "description".into(),
            Value::String(rpt.description.clone()),
        );
        props.insert(
            "amount".into(),
            Value::String(rpt.amount.to_string()),
        );
        props.insert(
            "currency".into(),
            Value::String(rpt.currency.clone()),
        );
        props.insert(
