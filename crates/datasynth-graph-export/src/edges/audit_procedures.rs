...
impl AuditProcedureEdgeSynthesizer {
    ...
    fn synthesize_step_in_workpaper(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
        let audit = &ctx.ds_result.audit;
        let mut edges = Vec::new();
    ...
    fn synthesize_step_uses_sample(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
    ...
    fn synthesize_step_evidence(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
        let audit = &ctx.ds_result.audit;
        let mut edges = Vec::new();
    ...
    fn synthesize_ap_for_account(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
    ...
    fn synthesize_ap_in_workpaper(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
        let audit = &ctx.ds_result.audit;
        let mut edges = Vec::new();
    ...
    fn synthesize_iaf_for_engagement(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
        let audit = &ctx.ds_result.audit;
        let mut edges = Vec::new();
    ...
    fn synthesize_report_from_iaf(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
    ...
    fn synthesize_rp_for_engagement(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
        let audit = &ctx.ds_result.audit;
        let mut edges = Vec::new();
    ...
    fn synthesize_rpt_with_party(&self, ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
    ...
    fn synthesize_rpt_journal_entry(&self, _ctx: &mut EdgeSynthesisContext<'_>) -> Vec<ExportEdge> {
