...
impl CompanyNameGenerator {
    ...
    pub fn new() -> Self {
        Self {
            founder_names: vec![
                "Anderson", "Baker", "Bennett", "Brooks", "Campbell", "Carter", "Chen",
                "Clark", "Collins", "Cooper", "Davis", "Edwards", "Evans", "Fisher",
                "Foster", "Garcia", "Graham", "Green", "Griffin", "Hall", "Hamilton",
                "Harris", "Harrison", "Hayes", "Henderson", "Hill", "Howard", "Hughes",
                "Jackson", "James", "Jenkins", "Johnson", "Jones", "Kelly", "Kennedy",
                "Kim", "King", "Kumar", "Lee", "Lewis", "Li", "Liu", "Lopez", "Martin",
                "Martinez", "Mason", "Meyer", "Miller", "Mitchell", "Moore", "Morgan",
                "Morris", "Murphy", "Nelson", "Nguyen", "O'Brien", "Palmer", "Parker",
                "Patel", "Patterson", "Perry", "Peterson", "Phillips", "Powell", "Price",
                "Reed", "Reynolds", "Richardson", "Roberts", "Robinson", "Rogers", "Ross",
                "Russell", "Sanders", "Schmidt", "Scott", "Shaw", "Singh", "Smith",
                "Spencer", "Stevens", "Stewart", "Sullivan", "Taylor", "Thomas", "Thompson",
                "Turner", "Walker", "Walsh", "Wang", "Ward", "Watson", "Weber", "Wells",
                "White", "Williams", "Wilson", "Wood", "Wright", "Yang", "Young", "Zhang",
            ],
            location_prefixes: vec![
                "Pacific", "Atlantic", "Midwest", "Northeast", "Southeast", "Southwest",
                "Western", "Eastern", "Northern", "Southern", "Central", "Coastal",
                "Mountain", "Valley", "Bay", "Harbor", "Lakeside", "Riverside",
                "Highland", "Lowland", "Metropolitan", "Regional", "National", "Global",
                "Continental", "Transatlantic", "American", "United", "Allied", "Premier",
            ],
            abstract_names: vec![
                "Apex", "Arcadia", "Ascend", "Atlas", "Aurora", "Beacon", "Catalyst",
                "Centrix", "Clearview", "Cogent", "Coretech", "Dynamix", "Eclipse",
                "Elevate", "Ember", "Encompass", "Endeavor", "Envision", "Equinox",
                "Evergreen", "Evolve", "Excel", "Forge", "Frontier", "Genesis", "Granite",
                "Horizon", "Ignite", "Illuminate", "Infinity", "Innovate", "Inspire",
                "Integrate", "Keystone", "Kinetic", "Latitude", "Lumina", "Magnitude",
                "Matrix", "Meridian", "Momentum", "Navigate", "Nexus", "Nova", "Nucleus",
                "Oasis", "Omega", "Optimize", "Orbit", "Paradigm", "Paramount", "Peak",
                "Pinnacle", "Pioneer", "Pivot", "Precision", "Prism", "Propel", "Pulse",
                "Quantum", "Quest", "Radiant", "Radius", "Reach", "Relay", "Resolve",
                "Sage", "Sentinel", "Skyline", "Solstice", "Spark", "Spectrum", "Sphere",
                "Summit", "Synapse", "Synergy", "Synthesis", "Terra", "Thrive", "Titan",
                "Transcend", "Trident", "Trinity", "Triumph", "Unified", "Vanguard",
                "Vector", "Velocity", "Venture", "Vertex", "Vista", "Voyager", "Zenith",
            ],
            industry_descriptors: IndustryDescriptors {
                manufacturing: vec![
                    "Manufacturing", "Industries", "Industrial", "Fabrication", "Production",
                    "Metalworks", "Components", "Assembly", "Machining", "Precision",
                    "Materials", "Systems", "Engineering", "Solutions", "Technologies",
                    "Products", "Works", "Equipment", "Tools", "Dynamics",
                ],
                retail: vec![
                    "Retail", "Stores", "Markets", "Outlets", "Shopping", "Mart", "Goods",
                    "Merchants", "Trading", "Distribution", "Supply", "Wholesale", "Direct",
                    "Consumer", "Brands", "Products", "Marketplace", "Commerce", "Sales",
                ],
                technology: vec![
                    "Technologies", "Tech", "Systems", "Software", "Solutions", "Digital",
                    "Computing", "Networks", "Data", "Cloud", "Cyber", "AI", "Analytics",
                    "Platforms", "Labs", "Innovations", "Interactive", "Intelligence",
                ],
                financial: vec![
                    "Financial", "Capital", "Investments", "Banking", "Trust", "Securities",
                    "Wealth", "Asset", "Advisory", "Holdings", "Ventures", "Partners",
                    "Credit", "Funding", "Finance", "Insurance", "Risk", "Portfolio",
                ],
                healthcare: vec![
                    "Healthcare", "Medical", "Health", "Therapeutics", "Pharma", "Biotech",
                    "Clinical", "Diagnostics", "Life Sciences", "Wellness", "Care",
                    "Surgical", "Devices", "Laboratories", "Medicine", "Biosciences",
                ],
                professional: vec![
                    "Consulting", "Advisory", "Associates", "Partners", "Services", "Group",
                    "Solutions", "Advisors", "Professionals", "Management", "Strategies",
                    "Resources", "Experts", "Specialists", "Counsel", "Practice",
                ],
                energy: vec![
                    "Energy", "Power", "Utilities", "Resources", "Renewables", "Solar",
                    "Wind", "Electric", "Petroleum", "Oil", "Gas", "Fuel", "Generation",
                    "Grid", "Sustainability", "Environmental", "Clean", "Green",
                ],
                transportation: vec![
                    "Logistics", "Transport", "Freight", "Shipping", "Carriers", "Express",
                    "Fleet", "Moving", "Hauling", "Transit", "Airways", "Lines", "Delivery",
                    "Distribution", "Supply Chain", "Trucking", "Rail", "Maritime",
                ],
                real_estate: vec![
                    "Properties", "Realty", "Real Estate", "Development", "Investments",
                    "Holdings", "Land", "Estates", "Commercial", "Residential", "Builders",
                    "Construction", "Management", "Capital", "Ventures", "Trust",
                ],
                telecom: vec![
                    "Communications", "Telecom", "Wireless", "Networks", "Connect",
                    "Broadband", "Cable", "Cellular", "Mobile", "Satellite", "Fiber",
                    "Media", "Digital", "Interactive", "Broadcasting", "Signals",
                ],
                construction: vec![
                    "Construction", "Builders", "Contractors", "Building", "Development",
                    "Infrastructure", "Engineering", "Projects", "Structural", "Civil",
                    "Architectural", "Design-Build", "General Contractors", "Fabricators",
                ],
                hospitality: vec![
                    "Hospitality", "Hotels", "Resorts", "Lodging", "Entertainment",
                    "Leisure", "Dining", "Restaurant", "Food Service", "Catering",
                    "Events", "Travel", "Tourism", "Recreation", "Gaming", "Venues",
                ],
            },
        }
    }
    ...
    fn select_adjective(&self, rng: &mut impl Rng) -> &'static str {
        const ADJECTIVES: &[&str] = &[
            "Advanced", "Premier", "Elite", "Quality", "Superior", "Professional",
            "Innovative", "Modern", "Strategic", "Dynamic", "Progressive", "Integrated",
            "Comprehensive", "Specialized", "Technical", "Precision", "Custom", "Global",
            "National", "American", "United", "Allied", "Universal", "General",
        ];
...
mod tests {
    ...
    fn test_company_name_generation() {
        ...
        for industry in Industry::all() {
            ...
            assert!(
                name.contains("Inc.") || name.contains("Corp.") || name.contains("LLC")
                    || name.contains("Ltd.") || name.contains("Co.") || name.contains("Company")
                    || name.contains("Group") || name.contains("Corporation")
            );
        }
    }
    ...
    fn test_acronym_style() {
        ...
        let has_acronym = name.split_whitespace().next()
