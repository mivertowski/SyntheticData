    ...
    pub fn new() -> Self {
        Self {
            ...
            generic_suffixes: vec![
                "Supply", "Supplies", "Solutions", "Services", "Systems", "Products",
                "Distribution", "Direct", "Express", "Pro", "Plus", "One",
            ],
        }
    }
...
impl CategoryTemplates {
    fn new() -> Self {
        Self {
            office_supplies: CategoryTemplate {
                prefixes: vec![
                    "National", "Premier", "United", "American", "Business", "Corporate",
                    "Office", "Executive", "Professional", "Quality", "Superior", "Essential",
                ],
                suffixes: vec![
                    "Supply", "Supplies", "Products", "Depot", "Warehouse", "Source",
                    "Direct", "Express", "Essentials", "Solutions", "Center", "Mart",
                ],
                descriptors: vec![
                    "Office", "Business", "Stationery", "Workplace", "Desktop", "Paper",
                    "Supply", "Equipment", "Furniture", "Ergonomic", "Organizational",
                ],
            },
            it_services: CategoryTemplate {
                prefixes: vec![
                    "Tech", "Digital", "Cloud", "Cyber", "Data", "Net", "Info", "Core",
                    "System", "Logic", "Smart", "Next", "Pro", "Advanced", "Global",
                ],
                suffixes: vec![
                    "Systems", "Solutions", "Technologies", "Tech", "IT", "Computing",
                    "Networks", "Services", "Group", "Partners", "Consulting", "Digital",
                ],
                descriptors: vec![
                    "Managed", "Professional", "Enterprise", "Integrated", "Strategic",
                    "Infrastructure", "Support", "Implementation", "Optimization",
                ],
            },
            it_hardware: CategoryTemplate {
                prefixes: vec![
                    "Tech", "Micro", "Mega", "Ultra", "Pro", "Elite", "Prime", "Core",
                    "Solid", "Fast", "Smart", "Advanced", "Dynamic", "Precision",
                ],
                suffixes: vec![
                    "Systems", "Hardware", "Electronics", "Components", "Tech", "Computing",
                    "Equipment", "Devices", "Solutions", "Products", "Machines",
                ],
                descriptors: vec![
                    "Computer", "Server", "Network", "Storage", "Desktop", "Laptop",
                    "Peripheral", "Enterprise", "Business", "Professional",
                ],
            },
            software: CategoryTemplate {
                prefixes: vec![
                    "Soft", "App", "Code", "Logic", "Data", "Info", "Digi", "Smart",
                    "Cloud", "Net", "Web", "Tech", "Sys", "Core", "Pro",
                ],
                suffixes: vec![
                    "Software", "Systems", "Solutions", "Technologies", "Applications",
                    "Platforms", "Labs", "Works", "Ware", "Tech", "Digital",
                ],
                descriptors: vec![
                    "Enterprise", "Business", "Cloud", "SaaS", "Analytics", "Automation",
                    "Integration", "Development", "Platform", "Application",
                ],
            },
            raw_materials: CategoryTemplate {
                prefixes: vec![
                    "American", "National", "United", "Global", "International", "Premium",
                    "Quality", "Industrial", "Commercial", "Wholesale", "Bulk",
                ],
                suffixes: vec![
                    "Materials", "Supply", "Industries", "Products", "Resources", "Commodities",
                    "Trading", "Distribution", "Suppliers", "Wholesale",
                ],
                descriptors: vec![
                    "Steel", "Metal", "Aluminum", "Chemical", "Polymer", "Plastic", "Rubber",
                    "Textile", "Paper", "Wood", "Industrial", "Raw", "Basic",
                ],
            },
            utilities: CategoryTemplate {
                prefixes: vec![
                ...
                suffixes: vec![
                    "Power", "Electric", "Energy", "Gas", "Water", "Utilities", "Services",
                    "Resources", "Generation", "Distribution",
                ],
                descriptors: vec![
                    "Power", "Electric", "Natural Gas", "Water", "Utility", "Energy",
                    "Municipal", "Public", "Green", "Renewable", "Sustainable",
                ],
            },
            professional_services: CategoryTemplate {
                prefixes: vec![
                    "Strategic", "Premier", "Elite", "Executive", "Professional", "Expert",
                    "Integrated", "Comprehensive", "Advanced", "Global", "National",
                ],
                suffixes: vec![
                    "Associates", "Partners", "Advisors", "Consulting", "Services", "Group",
                    "Solutions", "Advisory", "Professionals", "Experts",
                ],
                descriptors: vec![
                    "Business", "Management", "Strategy", "Operations", "Financial",
                    "Technical", "Professional", "Corporate", "Executive",
                ],
            },
            logistics: CategoryTemplate {
                prefixes: vec![
                    "Express", "Rapid", "Swift", "Fast", "Quick", "Reliable", "Secure",
                    "Global", "National", "Interstate", "Continental", "Trans",
                ],
                suffixes: vec![
                    "Logistics", "Freight", "Shipping", "Transport", "Carriers", "Moving",
                    "Express", "Delivery", "Distribution", "Supply Chain",
                ],
                descriptors: vec![
                    "Freight", "Cargo", "Shipping", "Transport", "Delivery", "Trucking",
                    "Warehousing", "Distribution", "Fulfillment", "3PL",
                ],
            },
            facilities: CategoryTemplate {
                prefixes: vec![
                    "Premier", "Professional", "Complete", "Total", "Full", "Integrated",
                    "Commercial", "Corporate", "Building", "Property",
                ],
                suffixes: vec![
                    "Services", "Management", "Maintenance", "Solutions", "Facilities",
                    "Properties", "Building Services", "Operations",
                ],
                descriptors: vec![
                    "Facility", "Building", "Property", "Janitorial", "Cleaning", "HVAC",
                    "Mechanical", "Electrical", "Plumbing", "Landscaping",
                ],
            },
            marketing: CategoryTemplate {
                prefixes: vec![
                    "Creative", "Digital", "Strategic", "Dynamic", "Bold", "Bright",
                    "Impact", "Vision", "Brand", "Media", "Social", "Content",
                ],
                suffixes: vec![
                    "Marketing", "Media", "Agency", "Creative", "Communications", "Advertising",
                    "Studios", "Group", "Partners", "Digital",
                ],
                descriptors: vec![
                    "Marketing", "Advertising", "Branding", "Digital", "Social Media",
                    "Content", "PR", "Communications", "Creative", "Design",
                ],
            },
            travel: CategoryTemplate {
                prefixes: vec![
                    "Global", "World", "International", "Premier", "Executive", "Corporate",
                    "Business", "Professional", "Elite", "VIP",
                ],
                suffixes: vec![
                    "Travel", "Tours", "Journeys", "Voyages", "Adventures", "Getaways",
                    "Expeditions", "Vacations", "Escapes", "Services",
                ],
                descriptors: vec![
                    "Travel", "Corporate Travel", "Business Travel", "Executive Travel",
                    "Leisure", "Vacation", "Tourism", "Hospitality",
                ],
            },
            insurance: CategoryTemplate {
                prefixes: vec![
                    "National", "American", "United", "Allied", "General", "Universal",
                    "Premier", "Select", "Liberty", "Guardian", "Sentinel", "Shield",
                ],
                suffixes: vec![
                    "Insurance", "Assurance", "Underwriters", "Risk", "Protection",
                    "Coverage", "Benefits", "Group", "Mutual",
                ],
                descriptors: vec![
                    "Insurance", "Risk", "Benefits", "Coverage", "Protection", "Liability",
                    "Property", "Casualty", "Life", "Health",
                ],
            },
            telecommunications: CategoryTemplate {
                prefixes: vec![
                    "Tele", "Net", "Com", "Link", "Connect", "Digi", "Tech", "Fiber",
                    "Wire", "Signal", "Broad", "Cell", "Mobile",
                ],
                suffixes: vec![
                    "Communications", "Telecom", "Networks", "Connect", "Link", "Tel",
                    "Com", "Net", "Systems", "Solutions",
                ],
                descriptors: vec![
                    "Telecom", "Communications", "Network", "Wireless", "Broadband",
                    "Fiber", "Cable", "Mobile", "Cellular", "Internet",
                ],
            },
            equipment: CategoryTemplate {
                prefixes: vec![
                    "Industrial", "Commercial", "Professional", "Heavy", "Precision",
                    "Quality", "Premium", "American", "National", "United",
                ],
                suffixes: vec![
                    "Equipment", "Machinery", "Tools", "Systems", "Products", "Supply",
                    "Rentals", "Sales", "Leasing", "Solutions",
                ],
                descriptors: vec![
                    "Equipment", "Machinery", "Industrial", "Construction", "Manufacturing",
                    "Agricultural", "Medical", "Scientific", "Laboratory",
                ],
            },
            maintenance: CategoryTemplate {
                prefixes: vec![
                    "Pro", "Expert", "Quality", "Reliable", "Trusted", "Complete",
                    "Total", "Full", "Premier", "Professional",
                ],
                suffixes: vec![
                    "Maintenance", "Repair", "Services", "Solutions", "Care", "Support",
                    "Technicians", "Mechanics", "Specialists",
                ],
                descriptors: vec![
                    "Maintenance", "Repair", "Service", "Technical", "Mechanical",
                    "Electrical", "HVAC", "Plumbing", "Building", "Equipment",
                ],
            },
            consulting: CategoryTemplate {
                prefixes: vec![
                    "Strategic", "Management", "Business", "Corporate", "Executive",
                    "Global", "International", "Professional", "Expert", "Premier",
                ],
                suffixes: vec![
                    "Consulting", "Consultants", "Advisory", "Advisors", "Partners",
                    "Associates", "Group", "Solutions", "Services",
                ],
                descriptors: vec![
                    "Management", "Strategy", "Operations", "Technology", "Financial",
                    "HR", "Organizational", "Change", "Transformation",
                ],
            },
            legal: CategoryTemplate {
                prefixes: vec![
                    "Law", "Legal", "Attorney", "Counsel", "Justice", "Rights",
                ],
                suffixes: vec![
                    "Associates", "Partners", "Group", "LLP", "Law Firm", "Legal",
                    "Attorneys", "Counselors", "Practice",
                ],
                descriptors: vec![
                    "Corporate", "Business", "Commercial", "Litigation", "Intellectual Property",
                    "Employment", "Real Estate", "Tax", "Securities",
                ],
            },
            staffing: CategoryTemplate {
                prefixes: vec![
                    "Pro", "Elite", "Premier", "Top", "Best", "Quality", "Express",
                    "Quick", "Rapid", "Flex", "Talent", "Career",
                ],
                suffixes: vec![
                    "Staffing", "Personnel", "Recruiting", "Employment", "Talent",
                    "Workforce", "Resources", "Solutions", "Services", "Agency",
                ],
                descriptors: vec![
                    "Staffing", "Recruiting", "Placement", "Temporary", "Contract",
                    "Permanent", "Executive", "Technical", "Professional",
                ],
            },
            catering: CategoryTemplate {
                prefixes: vec![
                    "Gourmet", "Premier", "Elite", "Classic", "Fine", "Grand",
                    "Royal", "Golden", "Silver", "Crystal",
                ],
                suffixes: vec![
                    "Catering", "Events", "Cuisine", "Kitchen", "Foods", "Dining",
                    "Banquets", "Hospitality", "Services",
                ],
                descriptors: vec![
                    "Catering", "Event", "Corporate", "Wedding", "Banquet", "Culinary",
                    "Food Service", "Hospitality", "Dining",
                ],
            },
            security: CategoryTemplate {
                prefixes: vec![
                    "Secure", "Safe", "Shield", "Guard", "Sentinel", "Watchdog",
                    "Eagle", "Hawk", "Elite", "Premier", "Professional",
                ],
                suffixes: vec![
                    "Security", "Protection", "Services", "Systems", "Solutions", "Guard",
                    "Patrol", "Monitoring", "Investigations",
                ],
                descriptors: vec![
                    "Security", "Protection", "Surveillance", "Guard", "Patrol", "Alarm",
                    "Access Control", "Cyber", "Physical", "Corporate",
                ],
            },
        }
    }
...
impl WellKnownBrands {
    fn new() -> Self {
        Self {
            office_supplies: vec![
                "Staples", "Office Depot", "ULINE", "Quill", "W.B. Mason",
                "Grainger", "Amazon Business", "Costco Business Center",
            ],
            it_services: vec![
                "Accenture", "Cognizant", "Infosys", "Wipro", "TCS", "IBM Global Services",
                "Deloitte Digital", "Capgemini", "HCL Technologies", "Tech Mahindra",
            ],
            it_hardware: vec![
                "Dell Technologies", "HP Inc.", "Lenovo", "Cisco Systems", "Apple",
                "Microsoft Surface", "Intel", "AMD", "NVIDIA", "IBM",
            ],
            software: vec![
                "Microsoft", "Oracle", "SAP", "Salesforce", "Adobe", "VMware",
                "ServiceNow", "Workday", "Intuit", "Autodesk",
            ],
            utilities: vec![
                "Duke Energy", "Dominion Energy", "Exelon", "Southern Company",
                "NextEra Energy", "American Electric Power", "Xcel Energy",
            ],
            logistics: vec![
                "FedEx", "UPS", "DHL", "XPO Logistics", "C.H. Robinson",
                "J.B. Hunt", "Ryder", "Schneider", "Old Dominion",
            ],
            telecommunications: vec![
                "AT&T", "Verizon", "T-Mobile", "Comcast Business", "CenturyLink",
                "Spectrum Enterprise", "Windstream", "Frontier",
            ],
            travel: vec![
                "American Express GBT", "CWT", "BCD Travel", "Egencia",
                "Corporate Travel Management", "Travel Leaders",
            ],
        }
    }
}
